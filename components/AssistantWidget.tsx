...
import { createChatSession, generateTTS, createLiveSession } from '../services/geminiService';
import { decode, decodeAudioData, blobToBase64 } from '../utils/audioUtils';
import type { Chat, LiveSession } from '@google/genai';
                ...
                onopen: () => {
                    ...
                    scriptProcessor.onaudioprocess = (audioProcessingEvent) => {
                        ...
                        liveSessionPromiseRef.current?.then((session) => {
                            session.sendRealtimeInput({ media: { data: btoa(String.fromCharCode(...new Uint8Array(new Int16Array(inputData.map(n => n * 32767)).buffer))), mimeType: 'audio/pcm;rate=16000' } });
                        });
                    };
